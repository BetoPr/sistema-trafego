/** Resolve numero real dos contatos @lid. npx tsx scripts/run-resolver-lid.ts [agenciaId] */
...
async function main() {
  ...
  console.log("Resolvendo numeros @lid...");
  const r = await resolverNumerosLid({ sb, agenciaId: AG, baseUrl, token, limite: 2000 });
