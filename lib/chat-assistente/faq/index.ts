...
export const AREAS: AreaFAQ[] = [
  { id: "dashboard", label: "Dashboard", keywords: ["dashboard","painel","kpi","metrica","grafico","resumo","visao geral","periodo","filtro periodo","atendimentos vs campanhas","atendimentos live","ticket medio","vendas crm"], conteudo: DASHBOARD },
  ...
  { id: "campanhas", label: "Trafego/Ads (beta)", keywords: ["campanha","anuncio","conjunto","meta ads","facebook ads","instagram ads","google ads","gasto ads","impressao","alcance","cliques","ctr","ctwa","capi","pixel","pixel campanhas","conversao","atribuicao venda","etiqueta campanha","pasta campanha","roas","cpl","cac","faturamento ads","investido","trafego","tabela anuncios","criativos","top campanhas","status donut","analise publico","icp"], conteudo: CAMPANHAS },
  { id: "pixel-vendas", label: "Pixel & Vendas (beta)", keywords: ["pixel vendas","capi","ctwa","click-id","purchase","addtocart","refund","reenviar evento","conversao meta","atribuicao","analise publico"], conteudo: PIXEL_VENDAS },
  { id: "relatorios", label: "Relatorios (beta)", keywords: ["relatorio","report","pdf","imagem do relatorio","agendar relatorio","semanal","mensal","diario","enviar relatorio","frequencia","periodo dias","formato pdf","formato imagem","formato texto","relatorio ads","relatorio meta","relatorio google"], conteudo: RELATORIOS },
  { id: "alertas", label: "Alertas (beta)", keywords: ["alerta","regra de alerta","aviso","gasto subiu","queda de lead","notificacao gasto","gasto dia","gasto mes","limite r$","template alerta","testar alerta","alerta meta","alerta google"], conteudo: ALERTAS },
  { id: "integracoes", label: "Canais WhatsApp", keywords: ["canal whatsapp","conectar whatsapp","novo canal","instancia uazapi","qr code","reconectar","desconectar canal","backfill midia","webhook canal","plataforma ios android","multi numero","whatsapp business","whatsapp comum","ver qr","caiu canal"], conteudo: INTEGRACOES },
  ...
  { id: "config-mcp", label: "MCP / Token API (avancado)", keywords: ["mcp","claude desktop","claude code","token api","cursor","programatico","sn_mcp","integracao externa","api externa"], conteudo: CONFIG_MCP },
